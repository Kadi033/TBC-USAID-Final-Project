      ...
      <main className="mb-20">
        <div className="flex bg-grey-900 py-6 px-5 rounded-xl gap-6 items-center mx-5 mt-5">
          ...
          <div>
            ...
            <h2 className="text-white pt-3 text-preset-1 font-sans">$384.98</h2>
          </div>
        </div>
        <div className="flex flex-col bg-white p-5 rounded-xl mx-5 mt-2 ">
          ...
          <div className="flex items-center justify-between mt-5">
            <p className="text-grey-500 text-preset-5 font-mono">Paid Bills</p>
        ...
        <div className="flex flex-col bg-white rounded-bl-xl rounded-br-xl px-5 pt-0 mx-5">
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              ...
              />
              <p className="text-preset-4 text-grey-900 font-sans">Spark Electric Solutions</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 2nd</p>
              <Image
                width={14}
                height={18}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">Serenity Spa & Wellness</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 3rd</p>
              <Image
                width={14}
                height={18}
                src={"/assets/logos/download.svg"}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">Elevate Education</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 4th</p>
              <Image
                width={14}
                height={18}
                src={"/assets/logos/download.svg"}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">Pixel Playground</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 11th</p>
              <Image
                width={14}
                height={18}
                src={"/assets/logos/download.svg"}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">Nimbus Data Storage</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 21st</p>
              <Image
                width={14}
                height={18}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">ByteWise</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 23rd</p>
              <Image
                width={14}
                height={18}
                src={"/assets/logos/download1.svg"}
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">EcoFuel Energy</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 29th</p>
              </div>
          ...
          <div className="flex flex-col gap-2 border-b py-5 border-gray-200">
            <div className="flex gap-4 items-center">
              <Image
                ...
                className="rounded-full"
              />
              <p className="text-preset-4 text-grey-900 font-sans">Aqua Flow Utilities</p>
            </div>
            <div className="flex justify-between">
              <div className="flex gap-2 items-center">
              <p className="text-preset-5 text-green font-mono">Monthly - 30th</p>
