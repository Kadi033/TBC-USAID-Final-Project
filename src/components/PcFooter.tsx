...
function PcFooter() {
  ...
  return (
    <footer className="max-lg:hidden fixed bg-grey-900 w-full max-w-[300px] h-screen rounded-tr-2xl rounded-br-2xl">
      ...
      <main className="pt-6 pr-6 flex flex-col">
        <div className="w-full ">
          <Link href="/">
            <button
              className={` w-full  flex gap-4 h-[56px] items-center justify-start pl-8 py-4 rounded-tr-lg rounded-br-lg ${
                isActive("/")
                  ? "bg-white border-l-4 border-green"
                  : "bg-[#201f24] hover:text-white"
              }`}
            >
              <svg
              ...
              <p
                className={`md:text-preset-3 font-sans ${
                  isActive("/") ? "text-grey-900" : "text-[#B3B3B3] hover:text-white"
                }`}
              >
                Overview
              </p>
        ...
        <div className="w-full ">
          <Link href="/transactions">
            <button
              className={` w-full  flex gap-4 h-[56px] items-center justify-start pl-8 py-4 rounded-tr-lg rounded-br-lg hover: ${
            ...
            >
              ...
              <p
                className={`md:text-preset-3  font-sans ${
                  isActive("/transactions") ? "text-grey-900" : "text-[#B3B3B3] hover:text-white"
                }`}
              >
                Transactions
              </p>
        ...
        <div className="w-full ">
          <Link href="/pots">
            ...
            >
              ...
              <p
                className={`md:text-preset-3  font-sans ${
                  isActive("/pots") ? "text-grey-900" : "text-[#B3B3B3] hover:text-white"
                }`}
              >
                Pots
              </p>
        ...
        <div className="w-full ">
          <Link href="/bills">
            ...
            >
              ...
              <p
                className={`md:text-preset-3  font-sans ${
                  isActive("/bills") ? "text-grey-900" : "text-[#B3B3B3] hover:text-white"
                }`}
              >
                Recurring Bills
              </p>
